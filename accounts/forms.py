...
class RegistrationForm(UserCreationForm):
    ...
    class Meta:
        ...
        widgets={
                 'first_name':forms.TextInput(attrs={"type":"text", "class":"form-control ",'name':'last_name', "placeholder":"", "aria-label":"Last name"}),
                 'last_name':forms.TextInput(attrs={"type":"text", "class":"form-control ",'name':'last_name', "placeholder":"", "aria-label":"Last name"}),
                 'username':forms.TextInput(attrs={"type":"text", "class":"form-control ",'name':'username', "placeholder":"", "aria-label":"Username"}),
